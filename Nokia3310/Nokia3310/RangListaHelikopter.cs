...
namespace Nokia3310
{
    public partial class RangListaHelikopter : Form
    {
        public RangListaHelikopter()
        {
            InitializeComponent();
            Lista();
            Init();
        ...
        private void Lista()
        {
            ...
            duzina = 0;
            using (StreamReader stream = File.OpenText("Helikopter.txt"))
            {
                String s = "";
        ...
        {
            using (StreamWriter sr = File.AppendText("Helikopter.txt"))
            {
